...
spawn(function()
    ...
    -- Function's Farming
     ...
     Main:Toggle("(Super) Fast Attack",true,function(value)
        _G.FastAttack = value
    end)      
    
        Settings:Toggle("Very  Fast Attack ",true,function(value)
...
Main:Toggle("Auto Trys Luckes", false, function(vu)
    TryLuck = vu
end)
spawn(function()
while wait(.1) do
...
Main:Toggle("Auto Random Surprise", false, function(vu) 
    AutoBuySurprise = vu
end)
spawn(function()
    while wait(.1) do
